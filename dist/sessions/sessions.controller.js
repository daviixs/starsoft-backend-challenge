...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Criar nova sessão de cinema' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de sessões retornada' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Consultar disponibilidade de assentos' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID da sessão (UUID)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Disponibilidade retornada' }),
